...
for col in range(8, 2008, 1):
    ...
    ws.cell(col, 9).value = s(input_x, input_y, input_z, input_t).numpy()[0][0]
    ...
    del tape
    ws.cell(col, 10).value = ds_x[0][0]
    ws.cell(col, 11).value = ds_y[0][0]
    ws.cell(col, 12).value = ds_z[0][0]
    ws.cell(col, 16).value = ds_t[0][0]
    ...
    del inner_tape
    del outer_tape
    ws.cell(col, 13).value = ds_xx[0][0]
    ws.cell(col, 14).value = ds_yy[0][0]
    ws.cell(col, 15).value = ds_zz[0][0]
